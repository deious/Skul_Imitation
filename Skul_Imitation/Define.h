...
enum OBJID { OBJ_PRIORITY, OBJ_PLAYER, OBJ_PROJECTILE, OBJ_MONSTER, OBJ_BOSS, OBJ_MOUSE, OBJ_TUTORIAL, OBJ_TRIGGER, OBJ_BUTTON, OBJ_COLLIDER, OBJ_HEAD, OBJ_EFFECT, OBJ_UI, OBJ_END };
